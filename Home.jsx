  ...
  return (
    <div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', minHeight: 460 }}>
        <div style={{ padding: '72px 48px 56px', display: 'flex', flexDirection: 'column', justifyContent: 'center', width: "723px" }}>
        ...
        <div style={{ background: 'var(--beige)', position: 'relative', overflow: 'hidden' }}>
          ...
          <img src={window.__resources && window.__resources.marijkeSessie || "assets/marijke-sessie.jpg"} alt="Marijke Koomen in gesprek met twee professionals aan tafel" style={{ objectPosition: 'center center', display: 'block', position: 'absolute', inset: 0, height: "52px", padding: "56px 45px 0px 0px", width: "765px", objectFit: "cover" }} />
        </div>
      </div>
      <SectionDivider />
